...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menuBG/sameyPink'));
		//bg.color = 0xFFea71fd;
		bg.screenCenter();
		...
		for (i in 0...ClientPrefs.arrowHSV.length) {
			...
			note.frames = Paths.getSparrowAtlas('Immunus_Showdown_Arrows');
			var animations:Array<String> = ['ImmunusShowdown_Filled_Note_Left0', 'ImmunusShowdown_Filled_Note_Down0', 'ImmunusShowdown_Filled_Note_Up0', 'ImmunusShowdown_Filled_Note_Right0'];
